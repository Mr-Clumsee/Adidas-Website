...
if (document.readyState=="loading"){
    document.addEventListener("DOMContentLoaded", ready);    /*❤️*/
}
else{
    ready();
}
...
function addProductToCart(title, price, productImg){
    ...
    var cartBoxContent = `<img src="${productImg}" alt="product1" class="cart-img">
...
// keep item in cart when page reloads with localstorage
